...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-27e92926.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-27e92926.js", "/./_app/chunks/vendor-326d125c.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-db152a49.js", "css": ["/./_app/assets/pages/__layout.svelte-95fe3854.css"], "js": ["/./_app/pages/__layout.svelte-db152a49.js", "/./_app/chunks/vendor-326d125c.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-cd87d1db.js", "css": [], "js": ["/./_app/error.svelte-cd87d1db.js", "/./_app/chunks/vendor-326d125c.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-f91a2fef.js", "css": [], "js": ["/./_app/pages/index.svelte-f91a2fef.js", "/./_app/chunks/vendor-326d125c.js"], "styles": null }, "src/routes/projects.svelte": { "entry": "/./_app/pages/projects.svelte-dc49aa7e.js", "css": [], "js": ["/./_app/pages/projects.svelte-dc49aa7e.js", "/./_app/chunks/vendor-326d125c.js"], "styles": null }, "src/routes/about.svelte": { "entry": "/./_app/pages/about.svelte-638836d9.js", "css": [], "js": ["/./_app/pages/about.svelte-638836d9.js", "/./_app/chunks/vendor-326d125c.js"], "styles": null } };
...
var Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"bg-white rounded-xl shadow-md p-5 w-52\n"}"><ul class="${""}"><li class="${""}"><a href="${"/"}"${add_attribute("class", segment === "/" ? "current" : "", 0)}>Home</a></li>
		<li class="${""}"><a href="${"/about"}"${add_attribute("class", segment === "/about" ? "current" : "", 0)}>About</a></li>
		<li class="${""}"><a href="${"/projects"}"${add_attribute("class", segment === "/projects" ? "current" : "", 0)}>Projects</a></li></ul></div>`;
});
var PageTransition = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"bg-white rounded-xl shadow-md p-5"}">${slots.default ? slots.default({}) : ``}</div>`;
});
...
<div class="${"px-5 max-w-lg xl:max-w-6xl lg:max-w-4xl md:max-w-2xl sm:max-w-xl mx-auto h-screen"}"><div class="${"flex gap-6 h-full w-full py-24 "}">${validate_component(Navigation, "Nav").$$render($$result, { segment: key }, {}, {})}

		<div class="${"w-full h-3/4"}">${validate_component(PageTransition, "PageTransition").$$render($$result, { refresh: key }, {}, {
...
<p class="${"break-words min-w-full"}">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sit amet eros lobortis,
	...
	fringilla rhoncus. Nullam molestie metus nisi, at dictum felis consequat convallis.
</p>`;
});
...
<h1 class="${""}">This is the about me page</h1>`;
});
