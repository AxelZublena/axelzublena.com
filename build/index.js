...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en" >\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body class="bg-grey-2 overflow-hidden">\n		<div id="svelte">' + body + "</div>\n	</body>\n</html>\n";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-eed2398f.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-eed2398f.js", "/./_app/chunks/vendor-a5d2a7e7.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "profile_pic.jpg", "size": 1986572, "type": "image/jpeg" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-edd0a5ab.js", "css": ["/./_app/assets/pages/__layout.svelte-7dafd5bd.css"], "js": ["/./_app/pages/__layout.svelte-edd0a5ab.js", "/./_app/chunks/vendor-a5d2a7e7.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-edacd838.js", "css": [], "js": ["/./_app/error.svelte-edacd838.js", "/./_app/chunks/vendor-a5d2a7e7.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-eead2fb3.js", "css": [], "js": ["/./_app/pages/index.svelte-eead2fb3.js", "/./_app/chunks/vendor-a5d2a7e7.js"], "styles": [] }, "src/routes/projects.svelte": { "entry": "/./_app/pages/projects.svelte-c60db77e.js", "css": [], "js": ["/./_app/pages/projects.svelte-c60db77e.js", "/./_app/chunks/vendor-a5d2a7e7.js"], "styles": [] }, "src/routes/skills.svelte": { "entry": "/./_app/pages/skills.svelte-c88c64d0.js", "css": [], "js": ["/./_app/pages/skills.svelte-c88c64d0.js", "/./_app/chunks/vendor-a5d2a7e7.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "/./_app/pages/about.svelte-36f4592c.js", "css": [], "js": ["/./_app/pages/about.svelte-36f4592c.js", "/./_app/chunks/vendor-a5d2a7e7.js"], "styles": [] } };
...
var MenuText = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { text } = $$props;
  let { href } = $$props;
  let { segment } = $$props;
  ...
  return `<div class="${""}"><a${add_attribute("href", href, 0)}${add_attribute("class", segment === href ? "current font-bold text-white mx-3 lg:text-2xl text-4xl" : "text-gray-200 hover:text-white mx-3 lg:text-xl text-2xl", 0)}>${escape2(text)}</a></div>`;
});
var Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.segment === void 0 && $$bindings.segment && segment !== void 0)
    $$bindings.segment(segment);
  return `<div class="${"flex lg:flex-col flex-row bg-grey-1 border-2 border-solid border-gray-200 rounded-xl shadow-xl p-5"}"><div><h1 class="${"text-4xl text-blue-400 mb-1"}">Axel<br>Zublena</h1>
		<p class="${"text-ml text-gray-300 mb-5"}">ICT Student</p></div>
	<div class="${"flex lg:flex-col flex-row lg:m-0 m-auto lg:items-start items-center"}">${each(links, (link) => `${validate_component(MenuText, "MenuText").$$render($$result, {
    text: link.text,
    href: link.href,
    segment
  }, {}, {})}`)}</div>
...
var Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `
<div class="${"text-gray-200 bg-grey-1 border-2 border-solid border-gray-200 rounded-xl shadow-xl p-5"}">
...
var PageTransition = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"h-full"}">${validate_component(Page, "Page").$$render($$result, {}, {}, {
    default: () => `${slots.default ? slots.default({}) : ``}`
  })}</div>`;
});
var css = {
  code: '@import url("https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap");div.svelte-4k97m6{font-family:Ubuntu,sans-serif}',
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script context=\\"module\\">\\n\\texport const load = async ({ page }) => ({\\n\\t\\tprops: {\\n\\t\\t\\tkey: page.path\\n\\t\\t}\\n\\t});\\n<\/script>\\n\\n<script>\\n\\timport '../app.postcss';\\n\\timport Nav from '../components/Navigation.svelte';\\n\\timport PageTransition from '../components/PageTransition.svelte';\\n\\texport let key;\\n<\/script>\\n\\n<div\\n\\tclass=\\"flex lg:flex-row flex-col justify-center h-screen m-auto gap-6 py-24 max-w-lg xl:max-w-6xl lg:max-w-4xl md:max-w-2xl sm:max-w-xl\\"\\n>\\n\\t<div class=\\"\\">\\n\\t\\t<Nav segment={key} />\\n\\t</div>\\n\\t<!-- <div class=\\"w-1 bg-gray-300 h-56\\" /> -->\\n\\n\\t<div class=\\"w-full h-full\\">\\n\\t\\t<PageTransition refresh={key}>\\n\\t\\t\\t<slot />\\n\\t\\t</PageTransition>\\n\\t</div>\\n</div>\\n\\n<style>@import url(\\"https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap\\");div{font-family:Ubuntu,sans-serif}</style>\\n"],"names":[],"mappings":"AA8BO,QAAQ,IAAI,wHAAwH,CAAC,CAAC,iBAAG,CAAC,YAAY,MAAM,CAAC,UAAU,CAAC"}`
};
var load$1 = async ({ page }) => ({ props: { key: page.path } });
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { key } = $$props;
  if ($$props.key === void 0 && $$bindings.key && key !== void 0)
    $$bindings.key(key);
  $$result.css.add(css);
  return `<div class="${"flex lg:flex-row flex-col justify-center h-screen m-auto gap-6 py-24 max-w-lg xl:max-w-6xl lg:max-w-4xl md:max-w-2xl sm:max-w-xl svelte-4k97m6"}"><div class="${" svelte-4k97m6"}">${validate_component(Navigation, "Nav").$$render($$result, { segment: key }, {}, {})}</div>
	

	<div class="${"w-full h-full svelte-4k97m6"}">${validate_component(PageTransition, "PageTransition").$$render($$result, { refresh: key }, {}, {
    default: () => `${slots.default ? slots.default({}) : ``}`
  })}</div>
</div>`;
});
...
<figure class="${"flex lg:flex-row flex-col gap-3 mb-6"}"><img src="${"/profile_pic.jpg"}" alt="${"profile_pic.jpg"}" width="${"500"}" height="${"500"}" class="${"object-cover h-56 w-56 rounded-xl"}">
	<div class="${"pl-3 "}"><h2 class="${"text-3xl text-gray pb-2"}">About me</h2>
		<div class="${"flex flex-row divide-x-2 pb-5"}"><div class="${"pr-4 text-gray-300"}"><p class="${"text-xl"}"><span class="${"text-blue-300"}">Nationality</span>: French</p>
				<p class="${"text-xl"}"><span class="${"text-blue-300"}">Age</span>: 19</p></div>
			<div class="${"pl-4"}"><p class="${"text-xl"}"><span class="${"text-blue-300"}">Languages</span>: French &amp; English</p>
				<p class="${"text-xl"}"><span class="${"text-blue-300"}">Passions</span>: Motorsports, CS &amp; cycling
				</p></div></div>
		<h2 class="${"text-3xl text-gray pb-2"}">Contact</h2>
		<div class="${"flex flex-row divide-x-2"}"><div class="${"pr-4"}"><p class="${"text-xl"}"><span class="${"text-blue-300"}">France</span>: +33 7 69 75 39 08</p>
				<p class="${"text-xl"}"><span class="${"text-blue-300"}">Netherlands</span>: +31 6 45 45 81 52</p></div>
			<div class="${"pl-4"}"><p class="${"text-xl"}"><span class="${"text-blue-300"}">Email</span>: axel.zublena@gmail.com</p>
				<p class="${"text-xl"}"><span class="${"text-blue-300"}">Address</span>: Middelburg, Netherlands</p></div></div></div></figure>

<h2 class="${"text-3xl text-gray-200"}">Skills</h2>

<h2 class="${"text-3xl text-gray-200"}">Projects</h2>`;
});
...
<h1 class="${"text-5xl text-red pb-5"}">Projects</h1>
<p class="${"break-words"}">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sit amet eros lobortis,
	ullamcorper risus vitae, vestibulum ligula. Donec feugiat sit amet mauris sit amet consectetur.
	Aenean eros arcu, finibus in metus eget, malesuada sagittis leo. Praesent eget purus non leo
	fringilla rhoncus. Nullam molestie metus nisi, at dictum felis consequat convallis. Lorem ipsum
	dolor sit amet, consectetur adipiscing elit. Suspendisse sit amet eros lobortis, ullamcorper risus
	vitae, vestibulum ligula. Donec feugiat sit amet mauris sit amet consectetur. Aenean eros arcu,
	finibus in metus eget, malesuada sagittis leo. Praesent eget purus non leo fringilla rhoncus.
	Nullam molestie metus nisi, at dictum felis consequat convallis.
</p>`;
});
...
<h1 class="${"text-5xl text-red pb-5"}">About</h1>
<figure class="${"flex flex-row content-center items-center gap-3 mb-6"}"><img src="${"/profile_pic.jpg"}" alt="${"profile_pic.jpg"}" width="${"500"}" height="${"500"}" class="${"object-cover h-28 w-28 rounded-xl"}">
	<div><h1 class="${"text-4xl text-gray-200"}">Axel<br>Zublena</h1></div></figure>`;
});
